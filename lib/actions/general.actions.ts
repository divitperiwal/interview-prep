...
export async function createFeedback(params: CreateFeedbackParams) {
  ...
  try {
    ...
    const {
      ...
      Please score the candidate from 0 to 100 in the following areas. Do not add cateogories that are not listed below.
      **Communication Skils** : Clarity, articulation , structured responses.
